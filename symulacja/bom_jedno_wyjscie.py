...
def czy_model_wykonalny(dane_wejsciowe, liczba_wyrobow, rozwiazane_modele,
                        bom, sciezka_zapisu, numer_modelu, nazwa_pliku_z_rozwiazaniem):
...
prawdopodobienstwo_utworzenia_polaczenia_miedzy_wyrobami = 50
liczba_okresow = 3
liczba_maszyn = 3
liczba_modeli = 10
powiekszanie_liczby_maszyn = 1
...
for liczba_wyrobow in zbior_liczba_wyrobow:
    for numer_modelu in range(0, liczba_modeli):
        ...
        while not wykonalny:
            ...
            wykonalny = czy_model_wykonalny(dane_wejsciowe, liczba_wyrobow,rozwiazane_modele, bom,
